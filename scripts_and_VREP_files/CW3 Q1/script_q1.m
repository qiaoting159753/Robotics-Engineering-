...
sampling_rate = 240;
[joint_q1a_data, velocity_q1a] = create_trajectory_1a(data_q1a,sampling_rate);
[joint_q1b_data, velocity_q1b] = create_trajectory_1b(data_q1b,sampling_rate);
[joint_q1c_data, velocity_q1c] = create_trajectory_1c(data_q1c,sampling_rate);

joint_profile = [joint_q1a_data; joint_q1b_data; joint_q1c_data];
velo_profile = [velocity_q1a; velocity_q1b; velocity_q1c];
