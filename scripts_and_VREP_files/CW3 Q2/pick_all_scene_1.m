...
thetas1 = fast_theta(Rectangle15,base);
target_theta_15 = thetas1(1,1:5);
...
%0.01
destination(3) = Rectangle13.position(3) + 2 * Rectangle14.bbox_max(3);
dest_theta_15 = destination_theta_(clientID,vrep,destination,'R15') + 0.01;
dest_theta_15 = dest_theta_15(1,1:5);

destination = Rectangle13.position;
destination(3) = Rectangle13.position(3) + 4 * Rectangle14.bbox_max(3);
dest_theta_14 = destination_theta_(clientID,vrep,destination,'R14') + 0.005;
